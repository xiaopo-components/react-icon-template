...
import Icon from "../assets/keyboard-arrow-right.svg";

const KeyboardArrowRight = React.ForwardRef<HTMLSpanElement, IconProps>(
  (props, ref) => (
...
KeyboardArrowRight.displayName = "IconKeyboardArrowRight";
